...
<main>
    <section id="product1" class="section-p1">
        ...
        <?php
        echo "<img src='/PAP/fotos/RoupaHomem.jpg' style='width: 100%; padding-bottom: 26px; alt='Descrição da Imagem'>";
        ...
        WHERE g.genero = 'Masculino' AND tr.TipoRoupa = 'SweatShirts'
